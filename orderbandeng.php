...
$query = mysql_query("SELECT * FROM produk where nama_produk='bandeng'");
...
<div class="col-sm-12" style="margin:15px 25px 15px 20px">
					...
					<div class="col-sm-9" >
						<div class="bootstrap-tab-text-grid-left">
									<img src="img/bandeng.jpg" alt=" " class="imgr">
							</div>
					...
					<div class="color-quality">
						...
						<a href="index.php?page=bandeng"><button class="bton bton2">INFO</button></a>
						
						
							<h5>Kuantitas :</h5>
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<input style="background-color: white; color: black" class="value-minus" type="button" value="-" id="mins" onclick="minus()">
