...
<ol style="margin:4px 0 0 15px">
	<li>Klasifikasi</li>		
		<ul style="margin:5px 0 5px 20px;">
			...
			<li>Sub Kingdom : Metazoa</li>
			<li>Filum : Arthropoda</li>
			<li>Subfilum : Crustacea</li>
			<li>Kelas : Malacostraca</li>
			<li>Subkelas : Eumalacostraca</li>
			<li>Superordo : Eucarida</li>
			<li>Ordo : Decapoda</li>
			<li>Subordo : Dendrobrachiata</li>
			<li>Genus : Litopenaeus</li>
			<li>Spesies : Litopenaeus vannamei</li>
		</ul>
	<li>Morfologi</li>
