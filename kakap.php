...
<p><img src="img/kakap.jpg" alt height="60%" width="60%" style="float:center;margin:8px 4px 4px 8px;
...
<a href="order.php" target="_blank" class="pesansekarang">ORDER</a></div>
