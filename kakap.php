...
<ol style="margin:4px 0 0 15px">
	...
	<p> &nbsp &nbsp&nbsp Ikan kakap memiliki dua jenis, dibedakan berdasarkan warna yakni :</p>
		<ul style="margin:1px 0 0 60px;">
			<li>Kakap Merah</li>
				<p style="text-align:justify;"><img src="img/kakap-merah.jpg" height="50%" width="50%" style="float:left;margin:8px 10px 8px 8px;">&nbsp &nbsp&nbsp Ikan kakap merah ini memiliki badan yang lebar dan juga memanjang. Kepala dari ikan ini juga memiliki bentuk yang gepeng serta agak cembung dan sirip punggung memiliki beberapa ruas. Pada bagian bawah penutup insangnya, terdapat semacam gerigi-gerigi yang berkontur kasar. Ikan ini mempunyai gigi-gigi yang tersusun di dalam rahang dengan organ gigi taring yang berada di posisi rahang atas sebelah paling luar. Ikan kakap merah sendiri termasuk kedalam jenis binatang karnivora.</p>
