...
$query = mysql_query("SELECT * FROM produk where nama_produk='kakap'");
...
<div class="col-sm-12" style="margin:15px 25px 15px 20px">
					...
					<div class="col-sm-9" >
						<div class="bootstrap-tab-text-grid-left">
									<img src="img/kakap.jpg" alt=" " class="imgr">
							</div>
					...
					<div class="color-quality">
						...
						<a href="index.php?page=kakap"> <button class="bton bton2">INFO</button> </a>
